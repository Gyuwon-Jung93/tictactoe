...
class TestRDFStore(unittest.TestCase):
    ...
    def test_add_and_get_first_move(self):
        #Expected first move
        self.helper.add_move(URIRef("http://localhost:8083/Square13/someId"), self.apiBot)
        #Test getting it from the graph
        result = self.helper.get_first_move()

        self.assertEqual(URIRef("http://localhost:8083/Square13/someId"), result)
        ...
        for s, p, o in self.helper.graph.triples((self.helper.game, self.helper.ttt.firstMove, None)):
            # Should only be one
            self.assertEqual(URIRef("http://localhost:8083/Square13/someId"), o)


    def test_add_and_get_next_move(self):
        #Expected first move

        sq13 = URIRef("http://localhost:8083/Square13/someId")
        self.helper.add_move(sq13, self.apiBot)
        #Next add this
        sq11 = URIRef("http://localhost:8083/Square11/someId")
    ...
    def test_get_board_some_occupied(self):
        self.helper.add_move(URIRef("http://localhost:8083/Square13/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square11/someId"), self.agentZero)
        squares = self.helper.get_board_occupied()
    ...
    def test_square_to_square_instance(self):
        expected_square_instance = URIRef("http://localhost:8083/Square11/someId")
    ...
    def test_square_instance_to_square(self):
        square_instance = URIRef("http://localhost:8083/Square11/someId")
    ...
    def test_get_winner_diagonal_right_left(self):
        ...
        self.helper.add_move(URIRef("http://localhost:8083/Square13/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square11/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square22/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square12/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square31/someId"), self.apiBot)
    ...
    def test_get_winner_diagonal_left_right(self):
        ...
        # - X -
        # - - X
        self.helper.add_move(URIRef("http://localhost:8083/Square11/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square12/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square22/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square13/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square33/someId"), self.apiBot)
    ...
    def test_get_winner_row_1(self):
        ...
        # - - -
        self.helper.add_move(URIRef("http://localhost:8083/Square11/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square21/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square12/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square22/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square13/someId"), self.apiBot)
    ...
    def test_get_winner_row_2(self):
        ...
        # X X X
        # - - -
        self.helper.add_move(URIRef("http://localhost:8083/Square21/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square11/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square22/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square12/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square23/someId"), self.apiBot)
    ...
    def test_get_winner_row_3(self):
        ...
        self.helper.add_move(URIRef("http://localhost:8083/Square31/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square11/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square32/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square12/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square33/someId"), self.apiBot)
    ...
    def test_get_winner_draw(self):
        ...
        self.helper.add_move(URIRef("http://localhost:8083/Square11/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square22/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square31/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square21/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square23/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square33/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square32/someId"), self.agentZero)
        self.helper.add_move(URIRef("http://localhost:8083/Square12/someId"), self.apiBot)
    ...
    def test_check_free_squares(self):
        ...
        sq11 = URIRef("http://localhost:8083/Square11/someId")
        sq12 = URIRef("http://localhost:8083/Square12/someId")
        sq13 = URIRef("http://localhost:8083/Square13/someId")
        sq21 = URIRef("http://localhost:8083/Square21/someId")
        sq22 = URIRef("http://localhost:8083/Square22/someId")
        sq23 = URIRef("http://localhost:8083/Square23/someId")
        sq31 = URIRef("http://localhost:8083/Square31/someId")
        sq32 = URIRef("http://localhost:8083/Square32/someId")
        sq33 = URIRef("http://localhost:8083/Square33/someId")
    ...
    def test_is_game_over_win(self):
        ...
        self.assertEqual(self.helper.is_game_over(), False)
        self.helper.add_move(URIRef("http://localhost:8083/Square21/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square33/someId"), self.agentZero)
        self.assertEqual(self.helper.is_game_over(), False)
        self.helper.add_move(URIRef("http://localhost:8083/Square23/someId"), self.apiBot)
        self.assertEqual(self.helper.is_game_over(), True)
    ...
    def test_is_square_free(self):
        ...
        value = self.helper.is_square_free(URIRef("http://localhost:8083/Square21/someId"));
        self.assertEqual(value, True)
        self.helper.add_move(URIRef("http://localhost:8083/Square21/someId"), self.apiBot)
        # False if square taken
        self.assertEqual(self.helper.is_square_free(URIRef("http://localhost:8083/Square21/someId")), False)
        # True if game still in play 
        self.assertEqual(self.helper.is_square_free(URIRef("http://localhost:8083/Square11/someId")), True)
        # False if game is over
        self.helper.add_move(URIRef("http://localhost:8083/Square22/someId"), self.apiBot)
        self.helper.add_move(URIRef("http://localhost:8083/Square23/someId"), self.apiBot)
        self.assertEqual(self.helper.is_square_free(URIRef("http://localhost:8083/Square11/someId")), False)


    def test_square_instance_from_number(self):
        result = self.helper.square_instance_from_number('12')
        self.assertEqual(result, URIRef("http://localhost:8083/Square12/someId"))

        result = self.helper.square_instance_from_number('22')
        self.assertEqual(result, URIRef("http://localhost:8083/Square22/someId"))

        result = self.helper.square_instance_from_number('31')
        self.assertEqual(result, URIRef("http://localhost:8083/Square31/someId"))